...
2. Define consent and purpose categories for worker/line records.
...
- safety-critical escalation path (electrical shock, ESD-sensitive
  component exposure, equipment condition)
- provenance for all operating records (worker and line both
