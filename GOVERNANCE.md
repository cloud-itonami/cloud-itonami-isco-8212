...
`cloud-itonami-isco-8212` is an OSS open-occupation blueprint. Governance covers
...
- Electrical/Electronic Assembly Line Scheduling Coordination Governor
  remains independent of the advisor.
...
- real worker/line/operator data stays outside Git.
...
- mishandling worker/line/operator data
